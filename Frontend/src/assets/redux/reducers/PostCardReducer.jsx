...
export const like = createAsyncThunk("like", async (payload) => {
  ...
  const id = payload.id;
  const url = `https://quikpik-back.vercel.app//post/${id}/like`;
  const option = {
    method: "PUT",
    headers: {
...
export const delPost = createAsyncThunk("delPost", async (payload) => {
  const id = payload.id;
  const url = `https://quikpik-back.vercel.app//post/${id}`;
  const option = {
    method: "DELETE",
    headers: {
      "Content-Type": "application/json",
...
export const bookmark = createAsyncThunk("bookmark", async (payload) => {
  const id = payload.id;
  const url = `https://quikpik-back.vercel.app//post/${id}/saveAPost`;
  const option = {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
...
export const follow = createAsyncThunk("follow", async (payload) => {
  const id = payload.id;
  const url = `https://quikpik-back.vercel.app//userFeed/follow/${id}`;
  const option = {
    method: "PUT",
    headers: {
      "Content-Type": "application/json",
